...
*Table 5* demonstrates the ability of our model to predict the sale price, given specific variables from the test data set. *Table 5* shows the predicted values for median and standard deviation are close to the median of the actual dataset. 
